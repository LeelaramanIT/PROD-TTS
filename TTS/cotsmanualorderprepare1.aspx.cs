        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((ddl_Category.SelectedValue.ToString() == "1" || ddl_Category.SelectedValue.ToString() == "2" || ddl_Category.SelectedValue.ToString() == "3") && (lbl_ProcessID.Text != "")
                    ...
                    //||(ddl_Category.SelectedValue.ToString() != "1" || ddl_Category.SelectedValue.ToString() != "2" || ddl_Category.SelectedValue.ToString() != "3") && (lbl_ProcessID.Text == ""))
                {
                ...
                {
                    lblErrMsg2.Text = "choose correct item try again";
