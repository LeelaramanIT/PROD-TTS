<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="claimstatustrack.aspx.cs" Inherits="TTS.claimstatustrack" %>
                ...
                <td align="center">
                    <table cellspacing="0" rules="all" border="1" class="tableCust">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlStatus" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged"
            ...
            <tr>
                <td align="center">
                    <asp:GridView runat="server" ID="gvClaimTrackList" AutoGenerateColumns="false" Width="1065px"
                        ...
                        onselectedindexchanged="gvClaimTrackList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="claimstatus" HeaderText="STATUS" ItemStyle-Width="230px" />
                            ...
                            <asp:GridView runat="server" ID="gvClaimApproveItems" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IMAGES" ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%# Build_ClaimImages(Eval("stencilno").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <div class='<%#Convert.ToInt32(Eval("statusid"))< 12 && Convert.ToInt32(Eval("statusid"))!= 4 && Convert.ToInt32(Eval("statusid"))!= 11? "divHide":"divShow" %>'>
                                            <div class="StatusMainDiv">
                                                <div class="StatusToggle" style="background-color: #DCDADA;">
                                        ...
                                        <div>
                                            <div class="StatusTitleDiv" style="background-color: #DCDADA;">
                                                PLANT ASSIGNED ON &nbsp;&nbsp;
                                                <%# Eval("stencilassignon")%>
                                                &nbsp;&nbsp;&nbsp;&nbsp; BY &nbsp;&nbsp;
                                                <%# Eval("stencilassignby")%>
                                            </div>
                                        </div>
