    ...
    public partial class claimstatustrack : System.Web.UI.Page
    {
        ...
        public string Build_ClaimImages(string strStencil)
        {
            ...
            try
            {
               ...
               var path = Server.MapPath("~/claimimages" + "/" + hdnCustCode.Value + "/" + lblClaimNo.Text + "/" + strStencil + "/");
               ...
               
                {
                    ...
                    foreach (string d in Directory.GetFiles(Server.MapPath("~/claimimages" + "/" + hdnCustCode.Value + "/" + lblClaimNo.Text + "/" + strStencil + "/")))
                    {
                        ...
                        {
                            string strURL = "/" + "claimimages" + "/" + hdnCustCode.Value + "/" + lblClaimNo.Text + "/" + strStencil + "/" + strImgName;
        ...
        protected void gvClaimTrackList_SelectedIndexChanged(object sender, EventArgs e)
        {
