    ...
    public partial class orderpositionentry : System.Web.UI.Page
    {
        ...
        private void Bind_txtValues()
        {
            try
            {
                ...
                dt = (DataTable)daErrDB.ExecuteReader_SP("sp_sel_OrderPosition_v1", DataAccess.Return_Type.DataTable);
        ...
        protected void btnPositionSave_Click(object sender, EventArgs e)
        {
            try
            {
                SqlParameter[] sp1 = new SqlParameter[]{
                    ...
                    new SqlParameter("@Puinflow", txtPuinflow.Text.Length > 0 ? Convert.ToDecimal(txtPuinflow.Text).ToString("0.00") : "0.00"),
                    new SqlParameter("@PuBacklog", txtPuBacklog.Text.Length > 0 ? Convert.ToDecimal(txtPuBacklog.Text).ToString("0.00") : "0.00"),
                    new SqlParameter("@PuDispatch", txtPuDispatch.Text.Length > 0 ? Convert.ToDecimal(txtPuDispatch.Text).ToString("0.00") : "0.00")
                };
                daErrDB.ExecuteNonQuery_SP("sp_ins_OrderPosition_v1", sp1);
        ...
        protected void btnPreviousMonthSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (btnPreviousMonthSave.Text != "")
                {
                    ...
                    daErrDB.ExecuteNonQuery_SP("sp_ins_OrderPosition_PreviousMonth_v1", sp1);
        ...
        protected void btnSaveOpenStock_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlParameter[] sp1 = new SqlParameter[]{
                    ...
                    new SqlParameter("@Puinflow", "0.00"),
                    new SqlParameter("@PuBacklog", txtOpenStockPu.Text.Length > 0 ? Convert.ToDecimal(txtOpenStockPdkMe.Text).ToString("0.00") : "0.00"),
                    new SqlParameter("@PuDispatch", "0.00")
                };
                daErrDB.ExecuteNonQuery_SP("sp_ins_OrderPosition_v1", sp1);
        ...
        private void Bind_MonthValues()
        {
            try
            {
                DataTable dt = (DataTable)daErrDB.ExecuteReader_SP("sp_sel_OrderPosition_Month_v1", DataAccess.Return_Type.DataTable);
                ...
                if (dt.Rows.Count > 0 && dt.Rows[0][0].ToString() != "")
                {
                    ...
                    hdnPuBacklog.Value    = dt.Rows[0]["PuBacklog"].ToString();
                    ...
                    txtPuBacklog.Text    = dt.Rows[0]["PuBacklog"].ToString();
